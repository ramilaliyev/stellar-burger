    ...
    return (
        <>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    <Input placeholder='Введите код из письма' onChange={handleChange(setToken)} value={token} required onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}/>
                </div>
                <div className="mb-20">
